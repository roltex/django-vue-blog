...
SECRET_KEY = 'django-insecure-cnb0fl27!dqu*fd@lq3k)d@y*oh%lrfnh#8=s#juvawn1&@i$j'
...
MIDDLEWARE = [
    'newBlog.middleware.CustomCorsMiddleware',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # App-specific static files
